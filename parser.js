  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_number() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, p1, p2) {return parseInt(p1 + p2.join(""));})(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_expression() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, a) {return ["quote", [a]]})(pos0, result0[1]);
          }
          if (result0 === null) {
            pos = pos0;
          }
